...
function NowPlayingView() {
  ...
  // blocks プロトコルで pixelSize = 表示セル幅。出力は pixelSize 幅 × pixelSize/2 高
  // セル縦横比 1:2 を加味すると pixelSize:pixelSize/2 = 2:1 セル → 視覚的に正方形
  const artSize = Math.min(Math.max(24, Math.floor(termWidth * 0.25)), 48)
